...
export default function ReportsByDatePage() {
  ...
  const filterByDate = () => {
    ...
    if (dateFrom) filtered = filtered.filter((a) => new Date(a.appointmentDate) >= new Date(dateFrom));
    if (dateTo) filtered = filtered.filter((a) => new Date(a.appointmentDate) <= new Date(dateTo + "T23:59:59"));
  ...
  const topDestinations = Object.entries(stats.byDestination).sort((a, b) => b[1] - a[1]).slice(0, 5);

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Relatórios por Data</h1>
        <p className="text-muted-foreground">Análise e estatísticas dos agendamentos por período</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            * A lista de passageiros será gerada apenas para a <strong>Data</strong> selecionada
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="flex items-end">
              <Button onClick={() => downloadMonthlyReport(selectedYearForMonth, selectedMonth)} className="w-full">
                <FileText className="h-4 w-4 mr-2" />
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex items-end">
              <Button onClick={() => downloadAnnualReport(selectedYear)} className="w-full">
                <FileText className="h-4 w-4 mr-2" />
