...
namespace HospitalTransport.Infrastructure.Migrations
{
    ...
    [Migration("20251118001717_AddIsInfantToAppointment")]
    partial class AddIsInfantToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.SystemControl", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsEnabled = true,
                            LastChanged = new DateTime(2025, 11, 18, 0, 17, 16, 673, DateTimeKind.Utc).AddTicks(8237),
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3948a484-5039-4c32-84a4-3a5e40af6445"),
                            CreatedAt = new DateTime(2025, 11, 18, 0, 17, 16, 673, DateTimeKind.Utc).AddTicks(8017),
