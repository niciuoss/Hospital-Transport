...
namespace HospitalTransport.Infrastructure.Migrations
{
    ...
    [Migration("20251016123433_RemovePatientUniqueIndexes")]
    partial class RemovePatientUniqueIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.SystemControl", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsEnabled = true,
                            LastChanged = new DateTime(2025, 10, 16, 12, 34, 32, 803, DateTimeKind.Utc).AddTicks(7966),
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a9fee50d-b848-4164-8e10-428d5321cc3e"),
                            CreatedAt = new DateTime(2025, 10, 16, 12, 34, 32, 803, DateTimeKind.Utc).AddTicks(7762),
