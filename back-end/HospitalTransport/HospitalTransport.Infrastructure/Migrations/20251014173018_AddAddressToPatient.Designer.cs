...
namespace HospitalTransport.Infrastructure.Migrations
{
    ...
    [Migration("20251014173018_AddAddressToPatient")]
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.SystemControl", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsEnabled = true,
                            LastChanged = new DateTime(2025, 10, 14, 17, 30, 17, 420, DateTimeKind.Utc).AddTicks(2375),
            ...
            modelBuilder.Entity("HospitalTransport.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0c2001b5-4f87-41da-a437-980a31ce951e"),
                            CreatedAt = new DateTime(2025, 10, 14, 17, 30, 17, 420, DateTimeKind.Utc).AddTicks(2155),
